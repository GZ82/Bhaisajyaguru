...
app.config['IMAGE_FOLDER'] = pkg_resources.resource_filename('remedies', 'static/images/')
app.config['SOUND_FOLDER'] = pkg_resources.resource_filename('remedies', 'static/sounds/') 
api = Api(app)
...
def streamwav():
    def generate():
        sound_bk = app.config['SOUND_FOLDER'] + 'bk_sound.wav'
